    ...
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
      <main className="flex-grow py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Search and Filters */}
          <div className="mb-8 bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm transition-all duration-300">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Search className="h-5 w-5 text-gray-400 dark:text-gray-300 transition-colors duration-300" />
                </div>
                <Input
                  type="text"
                  ...
                  className="pl-10 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 focus:ring-connectpro-primary focus:border-connectpro-primary transition-all duration-300"
                />
              </div>
            ...
            {/* Detailed Filters */}
            <div className="mt-4 border-t pt-4 border-gray-200 dark:border-gray-600 transition-colors duration-300">
          ...
          <div className="mb-4 flex justify-between items-center">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-[180px] rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 focus:ring-connectpro-primary focus:border-connectpro-primary transition-all duration-300">
          ...
          {filteredJobs.length > 0 ? (
            ...
            <div className="text-center py-12 bg-white dark:bg-gray-700 rounded-lg shadow-sm transition-all duration-300">
              <div className="mx-auto w-16 h-16 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center mb-4">
                <Briefcase className="h-8 w-8 text-gray-400 dark:text-gray-300 transition-colors duration-300" />
              </div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 transition-colors duration-300">No jobs found</h3>
              <p className="mt-2 text-gray-500 dark:text-gray-400 transition-colors duration-300">
                Try adjusting your search or filter criteria
              </p>
              <Button
                onClick={clearFilters}
                className="mt-4 bg-connectpro-primary hover:bg-connectpro-primary/90 text-white rounded-md transition-all duration-300"
              >
                Clear Filters
              </Button>
            </div>
